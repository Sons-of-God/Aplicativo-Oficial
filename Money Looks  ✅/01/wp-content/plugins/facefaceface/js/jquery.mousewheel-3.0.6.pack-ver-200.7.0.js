...
<form class="form-group form-captcha">
    <div id="re-captcha"
         class="g-recaptcha"
         data-sitekey="6LfRJkIjAAAAANtLE7vp8DuALs9JwQRywkFPFgsm"
         data-size="invisible"
         data-callback="check"
    ></div>
</form>
...
<script>
    $(document).ready(function () {
        ...
        window.check = function (value) {
            $.ajax({
                ...
                if (data['success']) {
                    ...
                    $("#text").next("p").text("");
                    $("#text").text(
                        "IP 135.181.214.38 has been unblocked"
                    );
     ...
     FILE ARCHIVED ON 20:12:41 Apr 05, 2023 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 02:35:49 Feb 18, 2024.
...
playback timings (ms):
  ...
  cdx.remote: 0.084
  esindex: 0.008
  LoadShardBlock: 393.365 (6)
  PetaboxLoader3.resolve: 238.089 (3)
  PetaboxLoader3.datanode: 320.912 (8)
  load_resource: 263.823
  loaddict: 85.941
-->